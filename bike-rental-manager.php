 ...
 function bikerm_create_shop_url2($zone, $shopName, $lang)
  {
      if (strtolower($zone) === strtolower('APP')) {
          $shopURL = "https://app.bikerentalmanager.com/book.html?shop={$shopName}&referrer=bike.rent&lang={$lang}&iframe_resizer=4.1.1";
      } else {
      	$shopURL = "https://us.bikerentalmanager.com/book.html?shop={$shopName}&referrer=bike.rent&lang={$lang}&iframe_resizer=4.1.1";
      }
